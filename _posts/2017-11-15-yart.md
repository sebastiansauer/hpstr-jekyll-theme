...
tags: [RMarkdown, knitr, template, rstats, LaTeX]
layout: post
---
...
## Thanks to
Yart, ie, this package leans on earlier work by [Aaron Wolen](http://aaronwolen.com/) in his
...
The bulk of the work has been done by John McFarlane's [pandoc](https://pandoc.org/), Donald Knuth's [LaTeX](https://www.latex-project.org/), and Yihui Xie's [knitr](https://yihui.name/knitr/), along with the earlier work of many.
